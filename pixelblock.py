...
class PixelBlock:
    CELL_WIDTH = 33  # This is a Pixels horizontal pitch
    CELL_HEIGHT = 33  # This is a Pixels vertical pitch
    CELL_MARGIN = 9  # This is the padding around each edge within a Pixel
