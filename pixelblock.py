...
class PixelBlock:
    CELL_WIDTH = 20  # This is a Pixels horizontal pitch
    CELL_HEIGHT = 20  # This is a Pixels vertical pitch
    CELL_MARGIN = 3  # This is the padding around each edge within a Pixel
